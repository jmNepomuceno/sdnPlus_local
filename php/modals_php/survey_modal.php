    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div id="modal-body" class="modal-body">
                ...
                <div class="nbs-update alert alert-info" role="alert" style="margin-bottom: 15px;">
                    <strong>📢 Update:</strong> The SDN Referral System now includes <strong>New Born Screening (NBS) classification</strong> to enhance newborn screening workflows. Please review your referrals accordingly.
                </div>

                <div id="session-time-lockout-survey" class="survey-content alert alert-info">
